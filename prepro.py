...
if __name__ == "__main__":
    ...
    # input json
    parser.add_argument('--input_train_json', default = "recon_vqa_raw_train.json", help='input json file to process into hdf5') #alternatively put required = 'True' to read during execution
    parser.add_argument('--input_test_json', default = "recon_vqa_raw_test.json", help='input json file to process into hdf5')
    parser.add_argument('--num_ans', default = 1000, type=int, help='number of top answers for the final classifications.')

    parser.add_argument('--output_json', default='recon_data_prepro.json', help='output json file')
    parser.add_argument('--output_h5', default='recon_data_prepro.h5', help='output h5 file')
